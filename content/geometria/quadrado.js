...
Se o lado do quadrado mede $l$, então:
* **Área:** $A = l^2$
...
Esse resultado é uma aplicação direta do [[teorema-de-pitagoras]] ao [[triangulo-retangulo]] formado pela diagonal. Mais do que isso: como $\\sqrt{2}$ é um [[numero-irracional]], o quadrado foi o palco do maior escândalo da história da [[matematica-grega]]: a descoberta de que a diagonal e o lado de um quadrado são **incomensuráveis** entre si.`;
})();
