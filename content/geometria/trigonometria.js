...
Essa **identidade trigonométrica fundamental** é o ponto de partida de toda a álgebra trigonométrica avançada. Note que ela é, no fundo, o próprio Pitágoras escrito em nova roupagem: $a^2 = b^2 + c^2$ com $a = 1$.`;
})();
