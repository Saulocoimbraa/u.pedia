(function () {
  ...
  window.UPEDIA_CONTENT["axiomas-fundamentais"] = `\n<div style="display: flex; justify-content: center; margin: 2rem 0;">
  
</div>\n\nAxiomas são as regras fundamentais do jogo matemático. São proposições aceitas como ponto de partida para definir um sistema — e a partir delas derivamos, por meio da lógica, todos os [[teoremas]] mais avançados.
